...
public class NullObjectConverter extends AbstractErlangJavaConverter<NullObject, OtpErlangAtom>{
    public NullObjectConverter() {
        super(NullObject.class, OtpErlangAtom.class);
    }
