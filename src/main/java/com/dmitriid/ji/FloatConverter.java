...
public class FloatConverter extends AbstractErlangJavaConverter<Float, OtpErlangFloat>{
    public FloatConverter() {
        super(Float.class, OtpErlangFloat.class);
    }
    ...
    protected Float fromErlang(OtpErlangFloat in) {
        try {
